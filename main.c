...
void print_help_menu() {
  ...
  move_terminal_cursor_down();
  printf("-r, --recursion_depth  The amount of recusion allowed when uncovering fields");
  move_terminal_cursor_down();
  printf("-a, --area, --size     Size of the game (must be given as comma seperated list of unsigned integers e.g 4, 4, 4, 4)");
  move_terminal_cursor_down();
